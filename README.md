## Exploratory Data Analysis: Peer Assessment 2 : Analysis of the NEI (National Emissions Inventory) Dataset
   -------------------------  ------------------ ------------------------------------------------------------
...
$PM_{2.5}$ Emissions Data (summarySCC_PM25.rds):
-------------------------------------------------
 This file contains a data frame with all of the PM2.5 emissions data for 1999, 2002, 2005, and 2008. For each year, the table contains number of tons of $PM_{2.5}$ emitted from a specific type of source for the entire year. Here are the first few rows.
...
Copy and paste the R code from the corresponding R file into the text box at the appropriate point in the peer assessments.